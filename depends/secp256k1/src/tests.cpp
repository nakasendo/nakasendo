...
# include "modules/keypuzzle/tests_impl.h"
#endif
...
int main(int argc, char **argv) {
    ...
    if (argc > 2) {
		...
		if (CryptGenRandom( hCryptProv, sizeof(seed16), seed16)){
			printf("Windows: Random sequence generated by CryptGenRandom. \n");
		}
		else{
			printf("Windows: Error during CryptGenRandom.\n");
			exit(1);
		}
#else
...
#ifdef ENABLE_MODULE_KEYPUZZLE
    /* keypuzzle tests */
    printf("begin keypuzzle tests\n");
    run_keypuzzle_tests();
    printf("end keypuzzle tests\n");
    return 0;
#endif
