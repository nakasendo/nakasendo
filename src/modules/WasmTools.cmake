...
macro(build_wasm_modules)##################################################
  ...
  foreach(_module IN LISTS module_list)
    ...
    if(CMAKE_CONFIGURATION_TYPES)
      ...
      add_custom_command(TARGET ${WASM_TARGET_NAME} POST_BUILD COMMAND cmd /c "$<IF:$<CONFIG:Debug>,${_WASM_BUILDER_DEBUG},${_WASM_BUILDER_RELEASE}> ${WASM_BITCODE_FILE} ${WASM_OUTPUT_FILE}")
    else()
    ...
    install(FILES "${WASM_OUTPUT_FILE}" DESTINATION "example/javascript" COMPONENT "Examples javascript")
  endforeach()
endmacro()
